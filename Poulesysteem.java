 ...
 * 
 */
public class Poulesysteem implements Serializable{
    ...
    public void laadToernooi(){
        toernooi = ToernooiLaden.laden();
    }
    
    public void saveToernooi(){
        ToernooiOpslaan.opslaan(toernooi);
    }
